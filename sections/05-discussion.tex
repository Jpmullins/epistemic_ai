...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Human-agent common ground.} Extending the framework to reason about the user's knowledge could support richer dialogue strategies and aligns with prior discourse modelling\cite{lascarides}.
\end{enumerate}
